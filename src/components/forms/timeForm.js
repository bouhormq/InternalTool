        ...
        return (
            <div className="z-10 overflow-y-auto fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
              ...
              {alertVisible  &&
                  ...
                  <strong class="font-bold">🧙‍♂️ Holy smokes! Are you a time traveler? That's literally impossible!</strong>
                  <span class="block sm:inline">Double check the inserted times again.</span>
